   ...
   stage('Snyk analysis'){
    ...
    stage('Static Security Assesment'){
      steps{
        ...
        sh 'sudo -S inspec exec https://github.com/dev-sec/linux-baseline -t docker://${IMAGE} --reporter html:/Linux_Baseline_report2.html --chef-license=accept || true | echo 123456789'
        ...
        //sh 'sudo -S 123456789 inspec exec https://github.com/dev-sec/linux-baseline -t docker://${IMAGE} --reporter html:/Linux_Baseline_report2.html --chef-license=accept || true'
